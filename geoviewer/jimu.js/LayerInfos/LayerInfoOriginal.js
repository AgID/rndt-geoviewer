...
portalUrlUtils, portalUtils, ConfigManager, esriRequest, esriConfig, ProjectParameters,
...
*/
    isShowInMap: function() {
      ...
      var currentLayerInfo = this;
      while(currentLayerInfo) {
        isShow = isShow && ( ( currentLayerInfo.isVisible && currentLayerInfo.isVisible() ) || currentLayerInfo._visible);
        currentLayerInfo = currentLayerInfo.parentLayerInfo;
      }
      return isShow;
    },   
    ...
    getSupportTableInfo: function() {
      ...
      all({
        ...
        } else if(layerType=="WMSLayer" && this.parentLayerInfo){        
          resultValue.isSupportQuery = this.parentLayerInfo.queryable;
