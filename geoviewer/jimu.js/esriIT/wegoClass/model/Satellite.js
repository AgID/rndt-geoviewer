...
define([
	...
	configModelFile,json) {
        return declare(null, {
            ...
            getSelectSatellite: function () {
                esriRequest({
                    url: this.configModel.sat.path,
                    content: {f:'json'},
                    callbackParamName: "callback",
                    timeout: this.timeoutValue,
                    handleAs: 'json',
                    load: lang.hitch(this, this.getSelectSatelliteSuccess),
                    error: lang.hitch(this, this.showError)
                }, {useProxy:false});

            },

            getSelectSatelliteSuccess: function(response){
                var that = this;
                ...
                if(folder.length>0){
                    ...
                    var arraySup = [];
                    this.select.innerHTML = '<option value="-1">Select nowcasting</option>';
