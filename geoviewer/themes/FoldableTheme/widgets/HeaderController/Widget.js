  ...
  function(declare, lang, array, html, aspect, query, on, Deferred, mouse,
    ...
    var clazz = declare([BaseWidget, PoolControllerMixin], {
      ...
      _createIconNodes: function(box) {
        ...
        array.forEach(this.appConfig.links, function(link) {
          if (link.icon) { 
            var l = {"id":"mioabout"+Math.random(), "icon":link.icon, "label":link.label};
            this._createIconNodeLink(l).onclick=function (){window.open(link.url,"_blank");};       
          }
        }, this);
      ...
      _createIconNodeLink: function(iconConfig) {
        var node, iconUrl;
