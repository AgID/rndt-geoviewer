        ...
        return all(defs).then(lang.hitch(this, function(results) {
          ...
          for (var i = 0; i < results.length; i++) {
            ...
            if (!geocode) {
			  ...
			  var placeholder = geocode.placeholder || geocode.name || this._getGeocodeName(geocode.url);
			  if( geocode.url.indexOf("://geocode.arcgis.com/")> -1 && this.nls && this.nls.goecoderEsriPlaceholder ){
				 placeholder = this.nls.goecoderEsriPlaceholder;
			  }
              var json = {
